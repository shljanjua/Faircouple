...
INSERT INTO plans (slug, name, tagline, description, tier, is_free, is_featured, trial_days, sort_order, badge, features, limits) VALUES
  ('free','Starter','Begin the fairness habit','Track the basics for free — daily emotions, one relationship space and weekly fairness scoring.',
   ...
   '["1 relationship space","Love & Care daily check-in","Send a little love & gratitude","Weekly fairness score (10 areas)","Our Story timeline & bucket list","Private couple chat (200 messages/mo)","1 shared checklist","100 MB secure storage"]',
  ...
  ('essential','Essential','For couples building the habit','Everything you need to keep effort, respect and loyalty balanced — with full travel planning.',
   ...
   '["Everything in Starter","Unlimited emotions & full 10-area fairness reports","Love vs Attraction assessment","The full Love & Care suite — Open-when letters, Storybook, voice notes","Love language + date-night generator","Streaks, couple challenges & long-distance mode","Unlimited private messaging, photos & Our Soundtrack","Shared budgeting, travel planner & itinerary generator","Ticket vault (5 GB) · 12 months history","Ad-free experience"]',
  ...
  ('premium','Premium','Deep insight and unlimited planning','Advanced fairness analytics, unlimited trips and documents, PDF exports and priority support.',
   ...
   '["Everything in Essential","Advanced fairness analytics & trends","Balance index + risk alerts","Guided conflict-repair flow & surprise mode","Custom fairness categories","Unlimited trips, itineraries & vault (50 GB)","Unlimited PDF/CSV exports","Gift planner with surprise mode","Priority email support","Unlimited history"]',
  ...
  ('lifetime','Lifetime','Pay once, keep forever','All Premium features, one payment, no renewals — including every future feature.',
   ...
   '["Everything in Premium, forever","Every future feature included","The complete Love & Care suite, unlimited","Lifetime ticket vault","Founding member badge","Priority support for life"]',
...
INSERT INTO seo_meta (path, title, description, keywords, priority, changefreq) VALUES
  ...
  ('/features','Features — Love & Care, Letters, Storybook, Fairness, Money & Travel',
   'The Love & Care hub, Open-when letters, voice notes, Our Story & Storybook, love language, date-night generator, couple challenges, conflict repair, surprise mode and long-distance mode — plus the 10-area fairness engine, fair budgeting and full travel planning.',
...
-- ---------------------------------------------------------------------------
-- LONG-DISTANCE + CHALLENGES (also in database/mysql/distance-challenges.sql)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- LOVE LANGUAGE + DATE NIGHT (also in database/mysql/love-language-datenight.sql)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- CONFLICT REPAIR + SURPRISES (also in database/mysql/repair-surprises.sql)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- SOUNDTRACK + VOICE NOTES + STORYBOOK (also in soundtrack-voice-story.sql)
-- ---------------------------------------------------------------------------
